...
public class TransactionController {
    ...
    public ResponseEntity<Object> createTransfer(Authentication authentication,
        ...
        if (fromAccountNumber == null){
            return new ResponseEntity<>("El numero de la cuenta de origen no existe", HttpStatus.FORBIDDEN);
        }
        if (toAccountNumber == null){
            return new ResponseEntity<>("El numero de la cuenta de destino no existe", HttpStatus.FORBIDDEN);
